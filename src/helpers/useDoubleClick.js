 ...
 *
 * @param {object} ref Dom node to watch for double clicks
 * @param {number} [latency=300] The amount of time (in milliseconds)
 * to wait before differentiating a single from a double click
